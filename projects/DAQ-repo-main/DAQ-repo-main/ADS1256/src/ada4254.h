...
public:
    ...
    uint8_t connectInputA(int CSPIN);
    bool connectInputB(int CSPIN);
    bool connectInputDVSS(int CSPIN);
    bool connectInputP20mv(int CSPIN);
    bool connectInputM20mv(int CSPIN);
    bool disconnectInputs(int CSPIN);
    bool setGain(GAIN val,int CSPIN);
    int  available(int CSPIN);
    void init(int CSPIN);
    bool isError(int CSPIN);
    int getAnalogError(int CSPIN);
    int getDigitralError(int CSPIN);
    bool clearError(int CSPIN);
    bool isBusy(int CSPIN);
    void calibration(int CSPIN);
...
// public:
    ...
    void writeRegister(int adr, int data, int CSPIN);
    void writeRegister(__data data, int CSPIN);
	  bool chekRegister(int adr, int data,int CSPIN);
	  bool chekRegister(__data data,int CSPIN);
    uint8_t  readRegister(int adr,int CSPIN);
    int  readRegister(__data data, int CSPIN);
